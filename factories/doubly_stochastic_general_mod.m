function [B, d_2, d_1, iter] = doubly_stochastic_general_mod(A, p, q, maxiter, checkperiod)
% Project a matrix to the doubly stochastic matrices (Sinkhorn's algorithm)
%
% function [B, d_2, d_1, iter] = doubly_stochastic_general(A, p, q)
% function [B, d_2, d_1, iter] = doubly_stochastic_general(A, p, q, maxiter)
% function [B, d_2, d_1, iter] = doubly_stochastic_general(A, p, q, [], checkperiod)
% function [B, d_2, d_1, iter] = doubly_stochastic_general(A, p, q, maxiter, checkperiod)
%
